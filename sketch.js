...
function preload(){
  ...
  opendoorsound=loadSound("sound/opendoorsound.mp3")
}

function setup() {
  createCanvas(displayWidth, displayHeight);
  
  door= createSprite(displayWidth/2, displayHeight/2-100, 50, 150);
 ...
 r=Math.random(1,5);
  ...
  switch(r){
    case 1: key=createSprite(200,500,20,20);
    key.addImage("rm",keyimg)
    key.scale=0.1
    
    break

    case 2: key=createSprite(400,500,20,20);
    key.addImage("rm",keyimg)
    key.scale=0.1

    break

    case 3: key=createSprite(600,500,20,20);
    key.addImage("rm",keyimg)
    key.scale=0.1

    break

    case 4: key=createSprite(800,500,20,20);
    key.addImage("rm",keyimg)
    key.scale=0.1

    break

    case 5: key=createSprite(1000,500,20,20);
    key.addImage("rm",keyimg)
    key.scale=0.1
